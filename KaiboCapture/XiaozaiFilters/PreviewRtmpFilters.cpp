...
bool CPreviewRtmpFilters::Uninit()
{
...
CPreviewRtmpFilters::CPreviewRtmpFilters()
{
	m_SuperSetting = new PreviewRtmpController();
	return;
}

CPreviewRtmpFilters::~CPreviewRtmpFilters()
{
	CPreviewRtmpFilters *pController = (CPreviewRtmpFilters *)m_SuperSetting;
	//SAFE_DELETE(pController);
}

int CPreviewRtmpFilters::Test(HWND hwnd)
{
	Init(XZ_LOG_VERBOSE);
