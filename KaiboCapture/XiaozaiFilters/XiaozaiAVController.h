...
#define XIAOZAI_QUIT    WM_USER+1
#define XIAOZAI_UPDATE  WM_USER+2

class  XiaozaiAVController :public CUnknown, public ISuperSettings, public OS::CThread
{
	...
	UINT  m_iUpdateMsg = XIAOZAI_UPDATE;
	RECT m_rtViewport;
...
public:
	XiaozaiAVController(LPUNKNOWN pUnk, HRESULT *phr);

	XiaozaiAVController();	

	virtual ~XiaozaiAVController();
