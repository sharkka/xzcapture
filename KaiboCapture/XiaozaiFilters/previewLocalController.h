...
#define PREVIEW_LOCAL_QUIT	      WM_USER+11
#define PREVIEW_LOCAL_UPDATE      WM_USER+12

class  PreviewLocalController :public CUnknown, public ISuperSettings, public OS::CThread
{
	...
	UINT  m_iUpdateMsg = PREVIEW_LOCAL_UPDATE;
	RECT m_rtViewport;
...
public:
	PreviewLocalController(LPUNKNOWN pUnk, HRESULT *phr);

	PreviewLocalController();

	virtual ~PreviewLocalController();
